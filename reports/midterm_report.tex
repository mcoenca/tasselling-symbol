...
Where $U$ is a $N \times D$ matrix of user features, $U_k$ is the k-th row of $U$, $I$ is a $D \times M$ matrix of item features, $I_l$ is the l-th row of $I$, and $D$ is a tunable number of dimensions.
