...
\subsection{Metacritic}
	...
	\begin{table}[H]
	 Distribution of number of reviews by users and critics for movies on metacritic\\
	 \begin{tabular}{| l | c | c | c | c |}
	 \hline 
	 &  Min & Max & Mean & Std Dev  \\
	 \hline
	...
	\begin{table}[H]
	 Distribution of number of reviewed movies for users and critics on metacritic \\
	 \begin{tabular}{| l | c | c | c | c |}
	 \hline
	 &  Min & Max & Mean & Std Dev  \\
	 \hline
